...
static int wsindicatortype               = INDICATOR_NONE; // INDICATOR_BOTTOM_BAR_SLIM
...
static int flexwintitle_separator        = 2;  // width of client separator
...
static const Rule clientrules[] = {
	...
	{ .class = "File-roller", .workspace = "3", .flags = Centered|Floating|SwitchWorkspace|RevertWorkspace },
...
static const WorkspaceRule wsrules[] = {
    ...
    {  "1",   -1,       0,       2,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "1",   "",   "", },
    {  "2",   -1,       0,       0,       .50,   -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "2",   "",   "", },
    {  "3",   -1,       0,       1,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "3",   "",   "ﴟ", },
    {  "4",   -1,       0,       2,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "4",   "",   "", },
    {  "5",   -1,       0,       4,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "5",   "",   "", },
    {  "6",   -1,       0,       0,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "6",   "",   "", },
    {  "7",   -1,       0,       0,       .75,   -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "7",   "",   "", },
    {  "8",   -1,       0,       1,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "8",   "",   "", },
    {  "9",   -1,       0,       1,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "9",   "",   "ﳑ", },
};
