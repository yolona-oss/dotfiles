...
static int wspinnedindicatortype         = INDICATOR_TOP_RIGHT_TRIANGLE;
...
static const Rule clientrules[] = {
	...
	{ .instance = "sptrans (t)", .scratchkey = 't', .flags = Floating },
	{ .class = "discord", .workspace = "4", .flags = Centered },
	{ .class = "TelegramDesktop", .workspace = "4", .flags = AttachMaster },
	...
	{ .class = "Luakit", .workspace = "7", .flags = Centered },
	{ .class = "Steam", .workspace = "5", .flags = IgnoreCfgReqPos|Floating|Centered },
	/* { .class = "steam_app_", .workspace = "5", .flags = SteamGame|IgnoreCfgReqPos|Floating|Centered|NoBorders }, */
	{ .class = "steam_app_", .workspace = "5", .flags = IgnoreCfgReqPos|Floating|Centered|NoBorders },
	{ .class = "Google-chrome", .role = "GtkFileChooserDialog", .floatpos = "50% 50%", .flags = Floating },
...
#define PWRLR PwrlLeftArrow
#define PWRLS PwrlBackslash
/* #define PWRL PwrlRightArrow */
	...
	{  0,    0,   0,      0,    0,    PWRLR,  BAR_ALIGN_RIGHT,       size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join"  },
	{ -1,    0,   0,      0,    0,    PWRL,  BAR_ALIGN_LEFT,        size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join"  },
	...
	{ -1,    0,   0,      0,    0,    PWRLR,  BAR_ALIGN_RIGHT,       size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join"  },
	{ -1,    0,   0,      0,    0,    PWRLS,  BAR_ALIGN_NONE,        size_wintitle_sticky,   draw_wintitle_sticky,   click_wintitle_sticky,   NULL,             "wintitle_sticky"  },
	{ -1,    0,   0,      0,    0,    PWRLS,  BAR_ALIGN_NONE,        size_flexwintitle,      draw_flexwintitle,      click_flexwintitle,      NULL,             "flexwintitle"  },
	/* Bottom bar */
	{ -1,    1,   0,      0,    0,    PWRLR,  BAR_ALIGN_LEFT_LEFT,   size_powerline,         draw_powerline,         NULL,                    NULL,             "powerline join"  },
	{ -1,    1,   0,      0,    0,    PWRL,  BAR_ALIGN_RIGHT_RIGHT, size_pwrl_ifhidfloat,   draw_powerline,         NULL,                    NULL,             "powerline join"  },
	{ -1,    1,   0,      40,   40,   7,     BAR_ALIGN_CENTER,      size_status,            draw_status,            click_status,            NULL,             "status7"  },
	{ -1,    1,   0,      0,    0,    PWRLR,  BAR_ALIGN_LEFT_LEFT,   size_wintitle_floating, draw_wintitle_floating, click_wintitle_floating, NULL,             "wintitle_floating"  },
...
/* static const char *spcmd_r[] = {"r", "st", "-n", "spfm (r)", "-g", "144x41", "-e", "ranger", NULL }; //file manager */
static const char *spcmd_r[] = {"r", "kitty", "--name", "spfm (r)", "-e", "ranger", NULL }; //file manager
static const char *spcmd_t[] = {"t", "st", "-n", "sptrans (t)", "-g", "144x41", "-e", "translate", NULL }; //translator
static const char *statusclickcmd[] = { NULL, "/bin/echo", NULL };
...
//NM applet
static const char *nm_dmenucmd[] = { "networkmanager_dmenu",\
                                     "-fn", dmenufont,
                                     "-nb", normbgcolor,
                                     "-nf", normfgcolor,
                                     "-sb", selbgcolor,
...
//Password manager
static const char *passmenucmd[] = { "passmenu2",
                                     "-fn", dmenufont,
                                     "-nb", normbgcolor,
                                     "-nf", normfgcolor,
                                     "-sb", selbgcolor,
...
/* static const char *scrotfcmd[] = { "scrot", */
/* 								   "%Y.%m.%d-%H:%M:%S_$wx$h.png", */
/* 								   "-u", */
/* 								   "-e", */
/* 								   "mv $f ~/screenshots" , NULL }; */
...
static Key keys[] = {
	...
	/* { KeyPress,         0,                  XF86XK_AudioRaiseVolume, spawn,                {.v = volume_upcmd } },      // volume control, volume up */
	/* { KeyPress,         0,                  XF86XK_AudioLowerVolume, spawn,                {.v = volume_downcmd } },    // volume control, volume down */
	/* { KeyPress,         0,                  XF86XK_AudioMute,        spawn,                {.v = volume_togglecmd } },  // volume control, mute */
	{ KeyPress,         MODKEY,             XK_p,                    spawn,                CMD("screenshot") },    //take screenshot
