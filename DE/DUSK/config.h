...
static const char *const autostart[] = {
	...
	"status_updater.sh", NULL, //status bar updater
...
static const Rule clientrules[] = {
	...
	{ .class = "steam_app_", .workspace = "5", .flags = SteamGame|IgnoreCfgReqPos|Floating|Centered },
...
static Key keys[] = {
	...
	{ KeyPress,   0,                            XK_Print,		 spawn,			         {.v = scrotcmd } }, //take screenshot
	{ KeyPress,   MODKEY,	           			XK_Print,		 spawn,			         {.v = scrotfcmd } }, //screenshot focused window
